...
# Answer: 333
peng_na_filtered <- penguins %>% na.omit()
str(peng_na_filtered)
head(peng_na_filtered)
...
# Answer:
peng_seperated <- penguins %>% select(species, island, body_mass_g)
head(peng_seperated)
