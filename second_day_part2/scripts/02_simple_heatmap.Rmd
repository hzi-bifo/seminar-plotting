...
## 4. Optional: highlight treatment and baseline/post status
...
## 5. Optional: compare two treatment groups side-by-side
...
## 7. Try a few clustering methods
...
## 8. Optional: inspect dendrograms directly
...
## 9. Which SNPs vary the most?

To focus on the most dynamic rows, compute the variance of each SNP and plot a
small heatmap of the top 20. This helps students see where the biggest changes
occur before moving to the advanced notebook.
