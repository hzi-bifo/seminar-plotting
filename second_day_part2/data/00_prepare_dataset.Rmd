...
`scripts/individual_notebooks/01_explore_data.Rmd` for the guided walkthrough, or try the exercises
notebook (`scripts/individual_notebooks/01_explore_data_exercises.Rmd`, with
`scripts/individual_notebooks/01_explore_data_exercises_solution.Rmd` as a key) that uses the
three-genome dataset, and finally render `scripts/individual_notebooks/02_simple_heatmap.Rmd` for the
visualization.
